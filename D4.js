...
// ESECUZIONE
const characters = [];
//questa è la creazione di un array vuoto che poi si potrà riempire con il comando "push"
...
for (let index = 0; index < starWarsCharacters.length; index++) {
  console.log(starWarsCharacters[index].name);
}
...
for (let index = 0; index < femaleCharacters.length; index++) {
  console.log(femaleCharacters[index]);
}
...
eyeColor.blu.push("Luke Skywalker");
eyeColor.yellow.push("C-3PO");
eyeColor.brown.push("Leia Organa");
eyeColor.red.push("R2-D2");
eyeColor.bluegray.push("Obi-Wan Kenobi");
console.log(eyeColor);

/* ESERCIZIO 5
  Inserisci l'oggetto dei personaggi di "starWarsCharacters" nell'array corrispondente al colore dei loro occhi nell'oggetto "eyeColor" precedentemente creato.
...
switch (eyeColor) {
  case eyeColor.blu:
    console.log("Luke Skywalker ha gli occhi:", eyeColor.blu);
    break;
  default:
    break;
}
